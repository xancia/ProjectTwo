...
export default function Home() {
  return (
    <div id="home" className="h-screen w-full bg-gradient-to-b from-gray-50 via-gray-50 to-gray-200 dark:from-slate-950 dark:via-slate-950 dark:to-slate-800 pt-24 md:pt-0 sm:pt-44">
